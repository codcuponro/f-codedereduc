            ...
            <div className='flex lg:flex-row flex-col gap-4 items-start mt-8'>
                ...
                >
                    <div className='relative z-[-1]'>
                        <button
                            className='h-[60px] flex justify-center z-[2] relative text-center items-center p-[8.5px] px-3 mt-3 rounded-[6px] flex-col w-full bg-[#0BC157] border-[2px] border-[#00A142] group-hover:bg-white '
                        >
