    ...
    return (
        <div className={`border border-[#DEE2E6] overflow-hidden rounded-lg`}>
            <div className='flex flex-row gap-3 sm:gap-4 sm:justify-center items-center md:gap-[27px]'>
                {
                    logo ? <Link href={"/magazine/" + item?.store?.Slug || "#"} target='_blank' className='md:border-r flex justify-center items-start p-4 sm:p-0 sm:items-center no-js'>
                ...
                <div className={`flex flex-col py-4 flex-1 justify-between pr-3 md:pr-[30px] sm:flex-row sm:items-center gap-4 ${logo && '!pl-0'}`}>
                    <div className='flex flex-col text-left md:justify-start md:items-start'>
                        <button className='bg-[#F3F4F6] px-2.5 w-fit text-xs text-dark font-bold py-1 rounded-full no-js'>
                    ...
                    <div className='hidden sm:block no-js'>
                        <CouponButton
            ...
            <div className='pl-2 pr-1 -mt-3 pb-2 sm:hidden no-js'>
                <CouponButton
                    label={item?.CouponsType !== "Promotion" && "Copiaza codul"}
                    title={item?.CouponCode}
                    data={item}
